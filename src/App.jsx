                ...
                {!isRecording && !isPreparing && (
                  <div className="absolute inset-0 flex items-center justify-center bg-black/70 backdrop-blur-md">
                    <div className="text-center">
                      <Camera className="w-10 h-10 text-gray-400 opacity-50 mx-auto mb-4" />
                      <p className="text-white text-lg opacity-80">Ready to start</p>
                    </div>
                  </div>
                )}
              </div>
            ...
            <div className="bg-black/50 backdrop-blur-xl rounded-2xl p-6 border border-white/25 shadow-2xl">
              ...
              {!isRecording && !isProcessing && !currentEmotions && (
                <div className="flex flex-col items-center justify-center h-full py-12">
                  <div className="mb-4">
                    <Play className="w-10 h-10 text-gray-400 opacity-50" />
                  </div>
                  <p className="text-gray-300 text-center max-w-xs text-lg font-medium opacity-80">Click "Start Session" to begin tracking emotions in real-time</p>
                </div>
              )}
